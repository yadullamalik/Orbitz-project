    ...
    return(
        <div>
            <div className="footer-container" >
                <div className="footer-box">
                      <div className="footer-img" >
                          <div>
                          <img src="https://a.travel-assets.com/globalcontrols-service/content/f285fb631b0a976202ef57611c7050e9ef5ca51a/images/EG_Wordmark_blue_RGB.svg" height="50%" width="50%" ></img>
                          </div>
                          </div>
                      <div>
                          <h3>Company</h3>
            ...
            <div className="footer-copywrite" >
                <p>© 2022 Orbitz, LLC, an Expedia Group Company.
                       All rights reserved.<br></br>
                       Orbitz, Orbitz.com, and the Orbitz logo are
                       trademarks or registered trademarks of Orbitz, 
                       LLC. CST# 2083930-50.</p>
            </div>
