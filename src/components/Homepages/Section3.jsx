    ...
    return(
        <div>
            <div className="help" >
             ...
             <div className="help-heading" ><h1>Here to help keep you on the move</h1></div>
              <div className="help-section" >
                <div>
                    <h2> Change or cancel the trip </h2>
                    <p>Make updates to your itenary or cancel the booking</p>
                    </div>
                    <div>
                    ...
                    <p>Check the status of a refund</p>
                    </div>
            ...
            <div className="ad1" >
                <div><img src="https://tpc.googlesyndication.com/simgad/10056509806482740393?" height="100%" width="100%" ></img></div>
          ...
          <div className="flex">
            <div className="selectdiv">
              ...
              <select class="select">
                ...
                <option value="+420,Czech_Republic">Czech Republic +420</option>
                ...
                <option value="+672,Norfolk_Island">Norfolk Island +672</option>
                ...
                <option value="+1,Turks_and_Caicos">Turks and Caicos +1</option>
        ...
        <div>
          ...
          <p>Scan the QR code</p>
            ...
            <h1 className="destination-head" >More destinations</h1>
